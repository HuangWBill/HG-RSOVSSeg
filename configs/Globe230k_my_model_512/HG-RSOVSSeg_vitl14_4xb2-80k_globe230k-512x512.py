_base_ = [
    ...
    '../_base_/datasets/Globe230k_my_dataset_512.py',
...
model = dict(data_preprocessor=data_preprocessor,
             ...
             text_encoder=dict(
                 ...
                 cache_feature=True,
                 # templates='imagenet_select_clip',       # 'imagenet','imagenet_select_clip', 'vild'
                 frozen='frozen_all',    # 'frozen_all'
             ),
             image_encoder=dict(
                 embed_dim=768,
                 out_idx=[7,15, 23],   # [5, 11, 17, 23][7,15, 23],
                 image_resolution=512,  # 不采用PEA时设置为224
                 vision_layers=24,
                 vision_heads=16,
                 vision_width=1024,
             ...
             neck=dict(
                 type='FA_Neck',
                 channels=1024,
                 out_channels=[128, 64],  # [64, 32], [128, 64], [256, 128], [256, 128, 64]
             ...
             decode_head=dict(
                 ...
                 channels=768,
                 in_channels=768,
                 key_channels=512,   # 256, 512, 1024
                 dropout=0.0,
                 decoder_dims=[128, 64],  # [64, 32], [128, 64], [256, 128], [256, 128, 64]
             ),
